...
1. **Create a new directory** named `$Language-$Model-with-hint` (e.g., `rust-opus4.5-with-hint`, `python-gpt4-with-hint`, `cpp-gemini3-with-hint`)
...
* Note that you can use advance features of operating systems and kernel like MMap or SIMD for CPUs if possible
